...
<footer class="p-4 flex items-center gap-8 text-lg">
	<a href="https://nathanblaylock.com" target="_blank" rel="noreferrer" class="flex gap-6">
		<svg width="36" viewBox="0 0 271 185" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path
	...
	<a href="https://nathanblaylock.com/privacy" target="_blank" rel="noreferrer">Privacy</a>
	<a href="/about">About</a>
	<a
		href="https://github.com/ngblaylock/color-scale-generator"
		target="_blank"
		rel="noreferrer"
		class="ml-auto"
	>
		<Icon icon="mdi:github" height="32px" />
	</a>
</footer>
